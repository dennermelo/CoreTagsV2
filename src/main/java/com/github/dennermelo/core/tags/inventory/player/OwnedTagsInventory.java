...
public class OwnedTagsInventory {
    ...
    public void open(Player player) {
        ...
        new InventoryBuilder<Tag>("Tags: Menu Principal", 4)
                ...
                .withItem(12, new ItemBuilder(ItemList.show_owned.clone()).setDurability((short) 10).setName("§aMostrando Tags Adquiridas").build(), (event, builder, value) -> {
